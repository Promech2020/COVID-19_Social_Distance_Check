...
if video_name == "":
	video_path="../input_video/VIRAT_S_010204_05_000856_000890.mp4" 
elif video_name == "0":
	video_path = int(video_name)
else :
	video_path = "../input_video/"+video_name

######################################### 
#		    Minimal distance			#
#########################################
minimum_distance = input("Prompt the size of the minimal distance between 2 pedestrians : ")
if minimum_distance == "":
	minimum_distance = "110"
...
frame_per_seconds = vs.get(cv2.CAP_PROP_FPS)
